...
namespace TDTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(State_KnockedDown, "State.KnockedDown", "On the floor. Refuses everything for the lockout, some of it for the input window, and takes movement throughout.");
