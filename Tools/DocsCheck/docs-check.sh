...
# unless it is explicitly demoted. ~280 / ~530 per Closing-Down.
...
out=$(check_budget Docs/Working-In-Unreal.md 530) && ok "budget" "Working-In-Unreal.md inside backstop" || warn "budget" "$out"
