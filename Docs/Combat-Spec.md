...
- **Knockdown** replaces what a graded hit does to its victim wholesale: it knocks down and **never** hitstuns.
  ...
  - **Exhaustion refuses block, dodge and kip-up** as the ordinary defensive actions they are, leaving the get-up attack, the neutral stand and the wait. **Being down is the one lockout that does not deny an exhausted player their regen** — the carve-out that prices the vortex out, so a knockdown nearly cures the exhaustion it lands on. *(The refusal half is verified; the regen half is a filed trap — nothing prints the stamina ledger inside a down-span.)*
